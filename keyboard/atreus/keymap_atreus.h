...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(                                                     \
        ...
        CAPS,LALT,LCTL,LSFT, SPC, ENT,BSPC, FN0, FN1, GRV,LGUI  ),
    ...
    KEYMAP(                                                     \
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS, DEL,TRNS,TRNS,TRNS,TRNS,TRNS  ),
    ...
    KEYMAP(                                                     \
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, FN2  )
